...
class RAGChat:
    ...
    def chat(self, user_query: str) -> str:
        ...
        prepared_template = prompty.prepare(prompty_obj, inputs= {"question":user_query, "context":retrieved_docs, "chat_history":[]})
        full_context = prepared_template[0]["content"]
        result = prompty.execute(data_path, inputs= {"question":user_query, "context":retrieved_docs, "chat_history":[]})
        return result